...
async function main() {
  ...
  console.log("stakedSgxTracker.claimable", (await stakedSgxTracker.claimable(account)).toString())
  console.log("bonusSgxTracker.claimable", (await bonusSgxTracker.claimable(account)).toString())
  console.log("feeSgxTracker.claimable", (await feeSgxTracker.claimable(account)).toString())
}
