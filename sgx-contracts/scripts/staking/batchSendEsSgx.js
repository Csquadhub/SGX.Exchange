...
const { DISTRIBUTION_LIST } = require("../../data/esSgxDistribution/distributionList1")
...
async function main() {
  ...
  await sendTxn(esSgx.approve(batchSender.address, expandDecimals(100 * 1000, 18)), "esSgx.approve")
