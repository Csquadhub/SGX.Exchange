...
async function getArbValues() {
  ...
  // const partnerContracts = [
  //   "0xbFbEe90E2A96614ACe83139F41Fa16a2079e8408", // Vovo SGXLP ETH up vault
  //   "0x0FAE768Ef2191fDfCb2c698f691C49035A53eF0f", // Vovo SGXLP ETH down vault
  //   "0x2b8E28667A29A5Ab698b82e121F2b9Edd9271e93", // Vovo SGXLP BTC up vault
  //   "0x46d6dEE922f1d2C6421895Ba182120C784d986d3", // Vovo SGXLP BTC down vault
  // ]
...
async function getBscTestnetValues() {
  ...
  const weth = await contractAt("WETH", tokens.nativeToken.address)
  const orderBook = await contractAt("OrderBook", "0xD6c69520936C07F61232279CDfee31F4D69D62A5")

  const orderKeeper = { address: "0x8e338d2246085CaD626603beFc82672fa7A9C025" }
  const liquidator = { address: "0x8e338d2246085CaD626603beFc82672fa7A9C025" }
