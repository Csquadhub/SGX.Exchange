...
async function getArbValues() {
  ...
  const sgx = new ethers.Contract("0xfc5A1A6EB076a2C7aD06eD22C90d7E710E35ad0a", BaseToken.abi, wallet)

  return { wallet, priceTxnUrl, priceKey, sgx }
}
...
async function getAvaxValues() {
  ...
  const sgx = new ethers.Contract("0x62edc0692BD897D2295872a9FFCac5425011c661", BaseToken.abi, wallet)
...
async function main() {
  const { wallet, priceTxnUrl, priceKey, sgx } = await getValues()

  let unsignedTxn = await sgx.populateTransaction.approve("0x5F799f365Fa8A2B60ac0429C48B153cA5a6f0Cf8", 100)
