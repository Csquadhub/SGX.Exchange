...
describe("Vault.withdrawCollateral", function () {
  ...
  beforeEach(async () => {
    ...
    const _ = await initVault(vault, router, sgusd, vaultPriceFeed)
  ...
  it("withdraw collateral long", async () => {
    ...
    expect(await sgxlpManager.getAumInSgusd(false)).eq("6726500000000000000000") // 6726.5
    expect(await sgxlpManager.getAumInSgusd(true)).eq("6726500000000000000000") // 6726.5
    ...
    expect(await sgxlpManager.getAumInSgusd(false)).eq("6726500000000000000500") // 6726.5000000000000005
    expect(await sgxlpManager.getAumInSgusd(true)).eq("6726500000000000000500") // 6726.5000000000000005

    await bnbPriceFeed.setLatestAnswer(toChainlinkPrice(400))
    await bnbPriceFeed.setLatestAnswer(toChainlinkPrice(400))
    await bnbPriceFeed.setLatestAnswer(toChainlinkPrice(400))

    expect(await sgxlpManager.getAumInSgusd(false)).eq("4171733333333333333600") // 4171.7333333333333336
    expect(await sgxlpManager.getAumInSgusd(true)).eq("4171733333333333333600") // 4171.7333333333333336
  ...
  it("withdraw collateral short", async () => {
    ...
    expect(await sgxlpManager.getAumInSgusd(false)).eq("7976000000000000000000") // 7976
    expect(await sgxlpManager.getAumInSgusd(true)).eq("7976000000000000000000") // 7976
    ...
    expect(await sgxlpManager.getAumInSgusd(false)).eq("8076000000000000000000") // 8076
    expect(await sgxlpManager.getAumInSgusd(true)).eq("8076000000000000000000") // 8076
    ...
    expect(await sgxlpManager.getAumInSgusd(false)).eq("7876000000000000000000") // 7876
    expect(await sgxlpManager.getAumInSgusd(true)).eq("7876000000000000000000") // 7876
