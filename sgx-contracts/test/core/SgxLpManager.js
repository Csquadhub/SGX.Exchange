...
describe("SgxLpManager", function () {
  ...
  it("inits", async () => {
    ...
    expect(await sgxlpManager.usdg()).eq(usdg.address)
  ...
  it("addLiquidity, removeLiquidity", async () => {
    ...
    expect(await usdg.balanceOf(sgxlpManager.address)).eq(0)
    ...
    expect(await usdg.balanceOf(sgxlpManager.address)).eq("99700000000000000000") // 99.7
    ...
    expect(await sgxlpManager.getAumInUsdg(true)).eq("99700000000000000000")
    expect(await sgxlpManager.getAumInUsdg(false)).eq("99700000000000000000")
    ...
    expect(await usdg.balanceOf(sgxlpManager.address)).eq("398800000000000000000") // 398.8
    ...
    expect(await sgxlpManager.getAumInUsdg(true)).eq("498500000000000000000")
    expect(await sgxlpManager.getAumInUsdg(false)).eq("398800000000000000000")
    ...
    expect(await sgxlpManager.getAumInUsdg(true)).eq("598200000000000000000") // 598.2
    expect(await sgxlpManager.getAumInUsdg(false)).eq("498500000000000000000") // 498.5
    ...
    expect(await usdg.balanceOf(sgxlpManager.address)).eq("997000000000000000000") // 997
    expect(await sgxlp.balanceOf(user0.address)).eq("99700000000000000000") // 99.7
    expect(await sgxlp.balanceOf(user1.address)).eq("299100000000000000000") // 299.1
    ...
    expect(await sgxlpManager.getAumInUsdg(true)).eq("1196400000000000000000") // 1196.4
    expect(await sgxlpManager.getAumInUsdg(false)).eq("1096700000000000000000") // 1096.7
    ...
    expect(await sgxlpManager.getAumInUsdg(true)).eq("1059312500000000000000") // 1059.3125
    expect(await sgxlpManager.getAumInUsdg(false)).eq("967230000000000000000") // 967.23
    ...
    expect(await sgxlpManager.getAumInUsdg(true)).eq("644785357142857143000") // 644.785357142857143
    expect(await sgxlpManager.getAumInUsdg(false)).eq("635608285714285714400") // 635.6082857142857144
  ...
  it("addLiquidityForAccount, removeLiquidityForAccount", async () => {
    ...
    expect(await sgxlp.totalSupply()).eq("398800000000000000000")
    expect(await sgxlpManager.lastAddedAt(user1.address)).eq(blockTime)
    expect(await sgxlpManager.getAumInUsdg(true)).eq("398800000000000000000")
