...
import * as sgxlpManager from "../generated/SgxLpManager/SgxLpManager"
...
export function handleAddLiquidity(event: sgxlpManager.AddLiquidity): void {
  ...
  entity.sgxlpSupply = event.params.sgxlpSupply
...
export function handleRemoveLiquidity(event: sgxlpManager.RemoveLiquidity): void {
  let entity = new RemoveLiquidity(event.transaction.hash.toHexString())

  entity.account = event.params.account.toHexString()
  entity.token = event.params.token.toHexString()
  entity.sgxlpAmount = event.params.sgxlpAmount
  entity.aumInUsdg = event.params.aumInUsdg
  entity.sgxlpSupply = event.params.sgxlpSupply
  entity.usdgAmount = event.params.usdgAmount
  entity.amountOut = event.params.amountOut
...
export function handleStakeSgx(event: rewardRouter.StakeSgx): void {
  let entity = new StakeSgx(event.transaction.hash.toHexString())
...
export function handleUnstakeSgx(event: rewardRouter.UnstakeSgx): void {
  let entity = new UnstakeSgx(event.transaction.hash.toHexString())
...
export function handleStakeSgxLp(event: rewardRouter.StakeSgxLp): void {
  let entity = new StakeSgxLp(event.transaction.hash.toHexString())
...
export function handleUnstakeSgxLp(event: rewardRouter.UnstakeSgxLp): void {
  let entity = new UnstakeSgxLp(event.transaction.hash.toHexString())
