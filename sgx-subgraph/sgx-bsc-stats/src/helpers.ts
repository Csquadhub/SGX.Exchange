...
export let SGX = "0xfc5a1a6eb076a2c7ad06ed22c90d7e710e35ad0a"
...
export function getTokenPrice(token: String): BigInt {
  if (token != SGX) {
    ...
    if (chainlinkPriceEntity != null) {
      ...
      // adjusting them to fit SGX 30 decimals USD values
      return chainlinkPriceEntity.value * BigInt.fromI32(10).pow(22)
    }
  }

  if (token == SGX) {
    let uniswapPriceEntity = UniswapPrice.load(SGX)
  ...
  prices.set(SGX, BigInt.fromI32(30) * PRECISION)
