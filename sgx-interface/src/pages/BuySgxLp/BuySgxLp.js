...
import SgxLpSwap from "../../components/SgxLp/SgxLpSwap";
import buySGXLPIcon from "../../img/ic_buy_glp.svg";
...
export default function BuySgxLp(props) {
    ...
    <div className="default-container page-layout">
      <div className="section-title-block">
        <div className="section-title-icon">
          <img src={buySGXLPIcon} alt="buySGXLPIcon" />
        </div>
        <div className="section-title-content">
          <div className="Page-title">
            <Trans>Buy / Sell SGXLP</Trans>
          </div>
      ...
      <SgxLpSwap {...props} isBuying={isBuying} setIsBuying={setIsBuying} />
      <Footer />
    </div>
  );
}
