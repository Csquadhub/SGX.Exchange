      ...
      <div className="default-container page-layout Referrals">
        <div className="section-title-block">
          ...
          <div className="section-title-content">
            ...
            <div className="Page-description">Job openings at SGX.</div>
          </div>
        </div>
...
function NoJob() {
  return (
    <Card title="No open positions at SGX currently">
      <div className="body-para">
        <p className="subheading">
          SGX is not actively looking for new hires at the moment. However, if you think you can contribute to the
...
//         <ul>
//           <li>Work closely with the SGX team on the SGX front-end website.</li>
...
//           </ul>
//           <p>The salary is 60,000 to 120,000 USD + 1,000 to 3,000 SGX a year.</p>
