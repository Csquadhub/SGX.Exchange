        ...
        <Modal isVisible={isVisible} setIsVisible={setIsVisible} label={title} className="non-scrollable">
          <div className="Exchange-swap-section">
            ...
            <div className="Exchange-swap-section-bottom">
              ...
              <div className="PositionEditor-token-symbol">esSGX</div>
            </div>
          </div>
          <div className="VesterDepositModal-info-rows">
            <div className="Exchange-info-row">
              <div className="Exchange-info-label">Wallet</div>
              <div className="align-right">{formatAmount(balance, 18, 2, true)} esSGX</div>
            </div>
            <div className="Exchange-info-row">
                  ...
                  renderContent={() => {
                    return (
                      <Trans>
                        ...
                        <br />
                        <br />
                        Deposited: {formatAmount(vestedAmount, 18, 2, true)} esSGX
                        <br />
                        Max Capacity: {formatAmount(maxVestableAmount, 18, 2, true)} esSGX
                        <br />
                      </Trans>
                    );
                  }}
                      ...
                      <Trans>
                        ...
                        {amount && nextReserveAmount.gt(maxReserveAmount) && (
                          <div>
                            ...
                            {stakeTokenLabel} to vest {formatAmount(amount, 18, 2, true)} esSGX.
                          </div>
                        )}
                      </Trans>
                    );
      ...
      <Modal isVisible={isVisible} setIsVisible={setIsVisible} label={title}>
        <Trans>
          <div>
            ...
            <br />
            <br />
            esSGX tokens that have been converted to SGX will remain as SGX tokens.
            <br />
            <br />
            To claim SGX tokens without withdrawing, use the "Claim" button under the Total Rewards section.
            <br />
            <br />
          </div>
        </Trans>
...
export default function StakeV2({ setPendingTxns, connectWallet }) {
  ...
  const gmxAddress = getContract(chainId, "SGX");
  const esGmxAddress = getContract(chainId, "ES_SGX");
  const bnGmxAddress = getContract(chainId, "BN_SGX");
  ...
  const stakedSgxLpDistributorAddress = getContract(chainId, "StakedSgxLpDistributor");
  ...
  const excludedEsGmxAccounts = [stakedGmxDistributorAddress, stakedSgxLpDistributorAddress];
  ...
  const rewardTrackersForDepositBalances = [
    ...
    feeGmxTrackerAddress,
    feeSgxLpTrackerAddress,
  ];
  const rewardTrackersForStakingInfo = [
    stakedGmxTrackerAddress,
    bonusGmxTrackerAddress,
    feeGmxTrackerAddress,
    stakedSgxLpTrackerAddress,
    feeSgxLpTrackerAddress,
  ];
  ...
  let totalRewardTokensAndSgxLp;
  if (totalRewardTokens && processedData && processedData.glpBalance) {
    totalRewardTokensAndSgxLp = totalRewardTokens.add(processedData.glpBalance);
  }
  ...
  const showStakeGmxModal = () => {
    if (!isGmxTransferEnabled) {
      helperToast.error(t`SGX transfers not yet enabled`);
      return;
    }

    setIsStakeModalVisible(true);
    setStakeModalTitle("Stake SGX");
    setStakeModalMaxAmount(processedData.gmxBalance);
    setStakeValue("");
    setStakingTokenSymbol("SGX");
  ...
  const showStakeEsGmxModal = () => {
    setIsStakeModalVisible(true);
    setStakeModalTitle("Stake esSGX");
    setStakeModalMaxAmount(processedData.esGmxBalance);
    setStakeValue("");
    setStakingTokenSymbol("esSGX");
  ...
  const showGmxVesterDepositModal = () => {
    ...
    setVesterDepositTitle("SGX Vault");
    setVesterDepositStakeTokenLabel("staked SGX + esSGX + Multiplier Points");
  ...
  const showSgxLpVesterDepositModal = () => {
    ...
    setIsVesterDepositModalVisible(true);
    setVesterDepositTitle("SGXLP Vault");
    setVesterDepositStakeTokenLabel("staked SGXLP");
    setVesterDepositMaxAmount(remainingVestableAmount);
    setVesterDepositBalance(processedData.esGmxBalance);
  ...
  const showGmxVesterWithdrawModal = () => {
    ...
    setVesterWithdrawTitle(t`Withdraw from SGX Vault`);
    setVesterWithdrawAddress(gmxVesterAddress);
  };

  const showSgxLpVesterWithdrawModal = () => {
    ...
    setIsVesterWithdrawModalVisible(true);
    setVesterWithdrawTitle(t`Withdraw from SGXLP Vault`);
  ...
  const showUnstakeGmxModal = () => {
    ...
    setUnstakeModalTitle(t`Unstake SGX`);
    ...
    setUnstakeValue("");
    setUnstakingTokenSymbol("SGX");
    setUnstakeMethodName("unstakeGmx");
  };

  const showUnstakeEsGmxModal = () => {
    setIsUnstakeModalVisible(true);
    setUnstakeModalTitle("Unstake esSGX");
  ...
  let earnMsg;
  if (totalRewardTokensAndSgxLp && totalRewardTokensAndSgxLp.gt(0)) {
    let gmxAmountStr;
    if (processedData.gmxInStakedGmx && processedData.gmxInStakedGmx.gt(0)) {
      gmxAmountStr = formatAmount(processedData.gmxInStakedGmx, 18, 2, true) + " SGX";
    }
    let esGmxAmountStr;
    if (processedData.esGmxInStakedGmx && processedData.esGmxInStakedGmx.gt(0)) {
      esGmxAmountStr = formatAmount(processedData.esGmxInStakedGmx, 18, 2, true) + " esSGX";
    }
    let mpAmountStr;
    ...
    if (processedData.glpBalance && processedData.glpBalance.gt(0)) {
      glpStr = formatAmount(processedData.glpBalance, 18, 2, true) + " SGXLP";
    }
    const amountStr = [gmxAmountStr, esGmxAmountStr, mpAmountStr, glpStr].filter((s) => s).join(", ");
    earnMsg = (
      <div>
        <Trans>
          You are earning {nativeTokenSymbol} rewards with {formatAmount(totalRewardTokensAndSgxLp, 18, 2, true)} tokens.
          <br />
          Tokens: {amountStr}.
        </Trans>
      </div>
    ...
    <div className="default-container page-layout">
      ...
      <div className="StakeV2-content">
        <div className="StakeV2-cards">
          <div className="App-card StakeV2-gmx-card">
            <div className="App-card-title">SGX</div>
            ...
            <div className="App-card-content">
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "gmxBalance", 18, 2, true)} SGX ($
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "gmxInStakedGmx", 18, 2, true)} SGX ($
                      ...
                      return (
                        <>
                          <div className="Tooltip-row">
                            <span className="label">Escrowed SGX APR</span>
                    ...
                    renderContent={() => {
                      return (
                        <>
                          ...
                          <div className="Tooltip-row">
                            <span className="label">Escrowed SGX</span>
                            <span>
                ...
                <div>
                  ...
                  {totalGmxStaked && (
                    <Tooltip
                      ...
                      renderContent={() => (
                        <>
                          Arbitrum: {formatAmount(arbitrumGmxStaked, 18, 0, true)} SGX
                          <br />
                          Avalanche: {formatAmount(avaxGmxStaked, 18, 0, true)} SGX
                        </>
                      )}
                    />
                  )}
              ...
              <div className="App-card-row">
                ...
                {totalGmxSupply && (
                  <div>
                    {formatAmount(totalGmxSupply, 18, 0, true)} SGX ($
          ...
          <div className="App-card primary StakeV2-total-rewards-card">
            ...
            <div className="App-card-content">
              ...
              <div className="App-card-row">
                <div className="label">Escrowed SGX</div>
                <div>
          ...
          <div className="App-card">
            <div className="App-card-title">SGXLP</div>
            <div className="App-card-divider"></div>
            <div className="App-card-content">
              <div className="App-card-row">
                <div className="label">
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "glpBalance", SGXLP_DECIMALS, 2, true)} SGXLP ($
              ...
              <div className="App-card-row">
                ...
                <div>
                  <Tooltip
                    handle={`$${formatKeyAmount(processedData, "totalSgxLpRewardsUsd", USD_DECIMALS, 2, true)}`}
                    position="right-bottom"
                    renderContent={() => {
                      return (
                        <>
                          <div className="Tooltip-row">
                            ...
                            <span>
                              {formatKeyAmount(processedData, "feeSgxLpTrackerRewards", 18, 4)} ($
                              {formatKeyAmount(processedData, "feeSgxLpTrackerRewardsUsd", USD_DECIMALS, 2, true)})
                            </span>
                          </div>
                          <div className="Tooltip-row">
                            <span className="label">Escrowed SGX</span>
                            <span>
                              {formatKeyAmount(processedData, "stakedSgxLpTrackerRewards", 18, 4)} ($
                              {formatKeyAmount(processedData, "stakedSgxLpTrackerRewardsUsd", USD_DECIMALS, 2, true)})
                            </span>
                          </div>
                        </>
                      );
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "glpSupply", 18, 2, true)} SGXLP ($
          ...
          <div className="App-card">
            <div className="App-card-title">Escrowed SGX</div>
            <div className="App-card-divider"></div>
            <div className="App-card-content">
              <div className="App-card-row">
                <div className="label">
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "esGmxBalance", 18, 2, true)} esSGX ($
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "esGmxInStakedGmx", 18, 2, true)} esSGX ($
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "stakedEsGmxSupply", 18, 0, true)} esSGX ($
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatAmount(esGmxSupply, 18, 0, true)} esSGX (${formatAmount(esGmxSupplyUsd, USD_DECIMALS, 0, true)}
                  )
                </div>
              </div>
              <div className="App-card-divider"></div>
      ...
      <div>
        ...
        <div>
          <div className="StakeV2-cards">
            <div className="App-card StakeV2-gmx-card">
              <div className="App-card-title">SGX Vault</div>
              <div className="App-card-divider"></div>
              <div className="App-card-content">
                <div className="App-card-row">
                  <div className="label">
                  ...
                  <div>
                    <Tooltip
                      ...
                      renderContent={() => {
                        return (
                          <>
                            {formatAmount(processedData.gmxInStakedGmx, 18, 2, true)} SGX
                            <br />
                            {formatAmount(processedData.esGmxInStakedGmx, 18, 2, true)} esSGX
                            <br />
                      ...
                      renderContent={() => {
                        return (
                          <>
                            ...
                            to SGX from the&nbsp;
                            {formatKeyAmount(vestingData, "gmxVesterVestedAmount", 18, 4, true)} esSGX deposited for
                            vesting.
                          </>
                        );
                      }}
                ...
                <div className="App-card-row">
                  ...
                  <div>
                    <Tooltip
                      handle={`${formatKeyAmount(vestingData, "gmxVesterClaimable", 18, 4, true)} SGX`}
                      position="right-bottom"
                      renderContent={() =>
                        `${formatKeyAmount(
                          vestingData,
                          ...
                          4,
                          true
                        )} ${t`SGX tokens can be claimed, use the options under the Total Rewards section to claim them.`}`
                      }
                    />
                  </div>
                </div>
            ...
            <div className="App-card StakeV2-gmx-card">
              <div className="App-card-title">SGXLP Vault</div>
              <div className="App-card-divider"></div>
              <div className="App-card-content">
                <div className="App-card-row">
                  <div className="label">
                  ...
                  <div>{formatAmount(processedData.glpBalance, 18, 2, true)} SGXLP</div>
                </div>
                <div className="App-card-row">
                  <div className="label">
                    <Trans>Reserved for Vesting</Trans>
                      ...
                      renderContent={() => {
                        return (
                          <>
                            ...
                            to SGX from the&nbsp;
                            {formatKeyAmount(vestingData, "glpVesterVestedAmount", 18, 4, true)} esSGX deposited for
                            vesting.
                          </>
                        );
                      }}
                ...
                <div className="App-card-row">
                  ...
                  <div>
                    <Tooltip
                      handle={`${formatKeyAmount(vestingData, "glpVesterClaimable", 18, 4, true)} SGX`}
                      position="right-bottom"
                      renderContent={() =>
                        `${formatKeyAmount(
                          vestingData,
                ...
                <div className="App-card-options">
                  ...
                  {active && (
                    <button className="App-button-option App-card-option" onClick={() => showSgxLpVesterDepositModal()}>
                      <Trans>Deposit</Trans>
                    </button>
                  )}
                  {active && (
                    <button className="App-button-option App-card-option" onClick={() => showSgxLpVesterWithdrawModal()}>
                      <Trans>Withdraw</Trans>
                    </button>
                  )}
                </div>
