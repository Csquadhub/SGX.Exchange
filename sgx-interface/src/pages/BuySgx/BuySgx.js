...
export default function BuySGX() {
  ...
  return (
    <div className="BuySGXSGXLP default-container page-layout">
      <div className="BuySGXSGXLP-container">
        {chainId === ARBITRUM && (
          <div className="section-title-block">
            <div className="section-title-content">
              ...
              <div className="Page-description">
                <Trans>ETH is needed on Arbitrum to purchase SGX.</Trans>
                <br />
                <Trans>
                  To purchase SGX on <span onClick={() => onNetworkSelect(AVALANCHE)}>Avalanche</span>, please change
                  your network.
                </Trans>
              </div>
            </div>
        ...
        {chainId === ARBITRUM && (
          <div className="BuySGXSGXLP-panel">
            <div className="App-card no-height">
              ...
              <div className="App-card-content">
                <div className="BuySGXSGXLP-description">
                  <Trans>
        ...
        {chainId === AVALANCHE && (
          <div className="section-title-block">
            <div className="section-title-content">
              ...
              <div className="Page-description">
                <Trans>Avax is needed on Avalanche to purchase SGX.</Trans>
                <br />
                <Trans>
                  {" "}
                  To purchase SGX on <span onClick={() => onNetworkSelect(ARBITRUM)}>Arbitrum</span>, please change your
                  network.
                </Trans>
              </div>
            </div>
            ...
            <div className="buy-card">
              ...
              <div className="App-card no-height">
                <div className="App-card-content no-title">
                  <div className="BuySGXSGXLP-description better-rates-description">
                    <Trans>
        ...
        {chainId === ARBITRUM && (
          <div className="BuySGXSGXLP-panel">
            ...
            <div className="buy-card">
              <div className="section-title-content">
                <div className="card-title">
                  <Trans>Buy SGX Bonds</Trans>
                </div>
              </div>
              <div className="App-card no-height">
                <div className="App-card-content no-title">
                  <div className="BuySGXSGXLP-description">
                    <Trans>SGX bonds can be bought on Olympus Pro with a discount and a small vesting period:</Trans>
                  </div>
                  <div className="buy-gmx">
                    <Button size="xl" imgSrc={ohmArbitrum} href="https://pro.olympusdao.finance/#/partners/SGX">
