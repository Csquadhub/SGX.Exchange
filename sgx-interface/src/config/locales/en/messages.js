/*eslint-disable*/ module.exports = {
  messages: {
    ", and use SGX with its built-in browser": ", and use SGX with its built-in browser",
    ...
    "Assets Under Management: SGX staked (All chains) + SGXLP pool ({chainName})": [
      "Assets Under Management: SGX staked (All chains) + SGXLP pool (",
      ["chainName"],
      ")",
    ],
    Available: "Available",
    "Available Liquidity": "Available Liquidity",
    "Available amount to deposit into SGXLP.": "Available amount to deposit into SGXLP.",
    "Available amount to withdraw from SGXLP.": "Available amount to withdraw from SGXLP.",
    "Available on your preferred network": "Available on your preferred network",
    "Available:": "Available:",
    Avalanche: "Avalanche",
    "Avalanche APR:": "Avalanche APR:",
    "Avax is needed on Avalanche to purchase SGX.": "Avax is needed on Avalanche to purchase SGX.",
    Balance: "Balance",
    "Balance:": "Balance:",
    Banxa: "Banxa",
    ...
    "Buy SGXLP": "Buy SGXLP",
    "Buy SGX": "Buy SGX",
    "Buy SGX Bonds": "Buy SGX Bonds",
    "Buy SGX or SGXLP": "Buy SGX or SGXLP",
    ...
    Claim: "Claim",
    "Claim SGX Rewards": "Claim SGX Rewards",
    "Claim completed!": "Claim completed!",
    "Claim esSGX": "Claim esSGX",
    "Claim esSGX Rewards": "Claim esSGX Rewards",
    ...
    Download: "Download",
    EARN: "EARN",
    "ETH is needed on Arbitrum to purchase SGX.": "ETH is needed on Arbitrum to purchase SGX.",
    Earn: "Earn",
    Ecosystem: "Ecosystem",
    Edit: "Edit",
    ...
    "Escrowed SGX APR": "Escrowed SGX APR",
    ...
    "SGXLP Index Composition": "SGXLP Index Composition",
    ...
    "SGX bonds can be bought on Olympus Pro with a discount and a small vesting period:":
      "SGX bonds can be bought on Olympus Pro with a discount and a small vesting period:",
    "SGX dashboards and analytics.": "SGX dashboards and analytics.",
    "SGX ecosystem pages.": "SGX ecosystem pages.",
    "SGX is currently live on Arbitrum and Avalanche.": "SGX is currently live on Arbitrum and Avalanche.",
    ...
    "SGX tokens can be claimed, use the options under the Total Rewards section to claim them.":
      "SGX tokens can be claimed, use the options under the Total Rewards section to claim them.",
    "SGX transfers not yet enabled": "SGX transfers not yet enabled",
    "SGX | Decentralized Perpetual Exchange": "SGX | Decentralized Perpetual Exchange",
    ...
    "Insufficient SGXLP balance": "Insufficient SGXLP balance",
    ...
    "Max pool capacity reached for {0}. Please mint SGXLP using another token": [
      ...
      ["0"],
      ". Please mint SGXLP using another token",
    ],
    ...
    "No esSGX to claim": "No esSGX to claim",
    ...
    Pay: "Pay",
    "Platform and SGXLP index tokens.": "Platform and SGXLP index tokens.",
    ...
    "Please input a referral code to benefit from fee discounts.":
      "Please input a referral code to benefit from fee discounts.",
    "Please mint SGXLP using another token": "Please mint SGXLP using another token",
    ...
    "Projects developed by the SGX community.": "Projects developed by the SGX community.",
    "Projects integrated with SGX.": "Projects integrated with SGX.",
    "Purchase <0>SGXLP tokens</0> to earn {nativeTokenSymbol} fees from swaps and leverages trading.": [
      "Purchase <0>SGXLP tokens</0> to earn ",
      ["nativeTokenSymbol"],
      " fees from swaps and leverages trading.",
    ],
    "Purchase SGX": "Purchase SGX",
    ...
    "Receiver has not staked SGXLP tokens before": "Receiver has not staked SGXLP tokens before",
    "Receiver has not staked SGX tokens before": "Receiver has not staked SGX tokens before",
    ...
    "Sell SGXLP": "Sell SGXLP",
    "Sell failed.": "Sell failed.",
    "Sell for {0}": ["Sell for ", ["0"]],
    "Sell submitted!": "Sell submitted!",
    "Selling...": "Selling...",
    "Sender has withdrawn all tokens from SGXLP Vesting Vault": "Sender has withdrawn all tokens from SGXLP Vesting Vault",
    "Sender has withdrawn all tokens from SGX Vesting Vault": "Sender has withdrawn all tokens from SGX Vesting Vault",
    Settings: "Settings",
    Share: "Share",
    ...
    Stake: "Stake",
    "Stake <0>SGX</0> and <1>SGXLP</1> to earn rewards.": "Stake <0>SGX</0> and <1>SGXLP</1> to earn rewards.",
    "Stake SGX Rewards": "Stake SGX Rewards",
    "Stake Multiplier Points": "Stake Multiplier Points",
    "Stake esSGX Rewards": "Stake esSGX Rewards",
    ...
    "The esSGX (IOU) token is transferrable. You can add the token to your wallet and send it to another address to claim if you'd like.":
      "The esSGX (IOU) token is transferrable. You can add the token to your wallet and send it to another address to claim if you'd like.",
    "The esSGX tokens can be staked or vested at any time.": "The esSGX tokens can be staked or vested at any time.",
    ...
    "Total value of tokens in SGXLP pool ({chainName})": ["Total value of tokens in SGXLP pool (", ["chainName"], ")"],
    Trade: "Trade",
    ...
    "Vault Capacity for your Account<0/><1/>Deposited: {0} esSGX<2/>Max Capacity: {1} esSGX<3/>": [
      ...
      ["0"],
      " esSGX<2/>Max Capacity: ",
      ["1"],
      " esSGX<3/>",
    ],
    "Vest with SGXLP on Arbitrum": "Vest with SGXLP on Arbitrum",
    "Vest with SGXLP on Avalanche": "Vest with SGXLP on Avalanche",
    "Vest with SGX on Arbitrum": "Vest with SGX on Arbitrum",
    "Vest with SGX on Avalanche": "Vest with SGX on Avalanche",
    "Vested SGXLP not withdrawn": "Vested SGXLP not withdrawn",
    "Vested SGX not withdrawn": "Vested SGX not withdrawn",
    ...
    "Withdraw from SGXLP Vault": "Withdraw from SGXLP Vault",
    "Withdraw from SGX Vault": "Withdraw from SGX Vault",
    ...
    "You have {0} esSGX (IOU) tokens.": ["You have ", ["0"], " esSGX (IOU) tokens."],
    ...
    order: "order",
    orders: "orders",
    "to start using SGX": "to start using SGX",
    "{0}": [["0"]],
    "{0} SGXLP (${1})": [["0"], " SGXLP ($", ["1"], ")"],
    "{0} SGXLP bought with {1} {2}!": [["0"], " SGXLP bought with ", ["1"], " ", ["2"], "!"],
    "{0} SGXLP have been reserved for vesting.": [["0"], " SGXLP have been reserved for vesting."],
    "{0} SGXLP sold for {1} {2}!": [["0"], " SGXLP sold for ", ["1"], " ", ["2"], "!"],
