/*eslint-disable*/ module.exports = {
  messages: {
    ", and use SGX with its built-in browser": ", そしてSGXをビルトインブラウザーで利用する",
    "24h Volume": "24時間取引高",
    ...
    '<0>This will withdraw and unreserve all tokens as well as pause vesting.<1/><2/>esSGX tokens that have been converted to SGX will remain as SGX tokens.<3/><4/>To claim SGX tokens without withdrawing, use the "Claim" button under the Total Rewards section.<5/><6/></0>':
      '<0>これによりすべてのトークンは引き出され、リザーブから解除され、べスティングは停止されます。<1/><2/>SGXへ転換されたesSGXトークンはSGXトークンとなります。<3/><4/>引き出しをせずにSGXトークンを請求するには全報酬セクションの下部にある"請求"ボタンを使用してください。<5/><6/></0>',
    ...
    "Assets Under Management: SGX staked (All chains) + SGXLP pool ({chainName})": [
      "管理資産: 全チェーンでステークされているSGX + SGXLPプール (",
      ["chainName"],
      ")",
    ],
    Available: "入手可能",
    "Available Liquidity": "入手可能な流動性",
    "Available amount to deposit into SGXLP.": "SGXLPに入金可能な金額",
    "Available amount to withdraw from SGXLP.": "SGXLPから出金可能な金額",
    "Available on your preferred network": "選択されたネットワークにて利用可能",
    "Available:": "利用可能",
    Avalanche: "Avalanche",
    "Avalanche APR:": "AvalancheでのAPR(実質年利)",
    "Avax is needed on Avalanche to purchase SGX.": "AvalancheでSGXを購入するにはAvaxが必要です。",
    Balance: "残高",
    "Balance:": "残高",
    Banxa: "Banxa",
    "Begin Transfer": "移転開始",
    ...
    "Buy SGXLP": "SGXLPを購入",
    "Buy SGX": "SGXを購入",
    "Buy SGX Bonds": "SGXボンドを購入",
    "Buy SGX or SGXLP": "SGXまたはSGXLPを購入",
    ...
    "Cancel {0} {orderText}": [["0"], " ", ["orderText"], " をキャンセル"],
    ...
    Claim: "請求",
    "Claim SGX Rewards": "SGX報酬の請求",
    "Claim completed!": "請求完了!",
    "Claim esSGX": "esSGXの請求",
    "Claim esSGX Rewards": "esSGX報酬の請求",
    ...
    "Convert esSGX tokens to SGX tokens.<0/>Please read the <1>vesting details</1> before using the vaults.":
      "esSGXトークンをSGXトークンに転換させる。<0/>ボールト使用前に <1>べスティングの詳細</1>を読んでください。",
    ...
    Distribution: "配分",
    Download: "ダウンロード",
    "ETH is needed on Arbitrum to purchase SGX.": "ArbitrumでSGXを購入するにはETHが必要です。",
    Earn: "報酬獲得",
    Ecosystem: "エコシステム",
    Edit: "編集",
    ...
    "Enter the amount of SGXLP you want to purchase in the order form, then check here to compare fees.":
      "購入したいSGXLPの額をオーダーフォームに入力し、ここをクリックして手数料を比較。",
    "Enter the amount of SGXLP you want to redeem in the order form, then check here to compare fees.":
      "売却したいSGXLPの額をオーダーフォームに入力し、ここをクリックして手数料を比較。",
    "Entry Price": "エントリー価格",
    "Escrowed SGX APR": "esSGXのAPR(実質年利)",
    "Execution Fee": "執行手数料",
    "Exit Price": "退出価格",
    FEES: "手数料",
    Fees: "手数料",
    "Fees may vary depending on which asset you sell SGXLP for.": "SGXLPを売却して入手する資産によって手数料は異なります。",
    "Fees may vary depending on which asset you use to buy SGXLP.":
      "SGXLPをどの資産で購入するかによって手数料は異なります。",
    ...
    French: "フランス語",
    "Funds not utilized by current open positions.": "現在オープンされているポジションで利用されていない資金",
    "SGXLP Index Composition": "SGXLPインデックス構成",
    ...
    "SGXLP is the liquidity provider token. Accrues 70% of the platform's generated fees.":
      "SGXLPは流動性提供者のトークンです。プラットフォームが得た手数料の70%を獲得します。",
    ...
    "SGX bonds can be bought on Olympus Pro with a discount and a small vesting period:":
      "SGXボンドはOlympus Proで短期のべスティング期間を条件として割引価格で購入できます:",
    "SGX dashboards and analytics.": "SGXのダッシュボードと分析",
    "SGX ecosystem pages.": "SGXエコシステムのページ",
    "SGX is currently live on Arbitrum and Avalanche.": "SGXは現在ArbitrumとAvalancheで稼働中です。",
    "SGX is the utility and governance token. Accrues 30% of the platform's generated fees.":
      "SGXはユーティリティトークン兼ガバナンストークンです。プラットフォームが得た手数料の30%を獲得します。",
    "SGX tokens can be claimed, use the options under the Total Rewards section to claim them.":
      "SGXトークンを請求することができます。請求するには全報酬セクションの下部にある選択肢を利用してください。",
    "SGX transfers not yet enabled": "SGX移転は有効化されていません",
    "SGX | Decentralized Perpetual Exchange": '"SGX | 分散型パーペチュアル取引所',
    ...
    "Get fee discounts and earn rebates through the SGX referral program.<0/>For more information, please read the <1>referral program details</1>.":
      "SGX紹介プログラムで手数料が割引されリベートが得られます。<0/>より詳しくは、 <1>こちらの紹介プログラム詳細を読んでください</1>.",
    ...
    "Insufficient SGXLP balance": "SGXLP残高不足",
    "Insufficient liquidity": "流動性不足",
    'Insufficient liquidity", true, "BUFFER"': '流動性不足", true, "バッファー"',
    ...
    "Max pool capacity reached for {0}": [["0"], "の最大プールキャパシティ到達"],
    "Max pool capacity reached for {0}. Please mint SGXLP using another token": [
      ["0"],
      "の最大プールキャパシティ到達。別のトークンを使用してSGXLPをミントしてください。",
    ],
    ...
    "No esSGX to claim": "請求できるesSGXはありません",
    ...
    Pay: "支払い額",
    "Platform and SGXLP index tokens.": "プラットフォームとSGXLPインデックストークン",
    "Please enter an amount to see fee percentages": "金額を入力して手数料率を確認してください",
    "Please input a referral code to benefit from fee discounts.": "紹介コードを入力すると手数料割引を受けられます。",
    "Please mint SGXLP using another token": "別のトークンを使用してSGXLPをミントしてください",
    ...
    "Price {0} Mark Price": ["価格 ", ["0"], " マーク価格"],
    Profit: "利益",
    "Profits In": "利益",
    "Projects developed by the SGX community.": "SGXコミュニティが開発したプロジェクト",
    "Projects integrated with SGX.": "SGXと統合されているプロジェクト",
    "Purchase <0>SGXLP tokens</0> to earn {nativeTokenSymbol} fees from swaps and leverages trading.": [
      "<0>SGXLP tokens</0>を購入して、スワップとレバレッジ取引から",
      ["nativeTokenSymbol"],
      "手数料を獲得する.",
    ],
    "Purchase SGX": "SGX購入",
    ...
    "Receiver has not staked SGXLP tokens before": "受け取り側ではこれまでにSGXLPトークンをステークしたことがありません",
    "Receiver has not staked SGX tokens before": "受け取り側ではこれまでにSGXトークンをステークしたことがありません",
    ...
    Referrals: "紹介アカウント",
    "Requested decrease of {0} {1} by {2} USD.": [["0"], " ", ["1"], " の ", ["2"], " USDの削減を要求しました。"],
    ...
    "Requested withdrawal of {0} USD from {1} {2}.": [["1"], " ", ["2"], "からの", ["0"], " USDの出金を要求しました。"],
    ...
    "Sender has withdrawn all tokens from SGXLP Vesting Vault":
      "送信側はSGXLPのべスティングボールトからすべてのトークンを引き出しました。",
    "Sender has withdrawn all tokens from SGX Vesting Vault":
      "送信側はSGXのべスティングボールトからすべてのトークンを引き出しました。",
    Settings: "設定",
    Share: "シェア",
    ...
    Stake: "ステーク",
    "Stake <0>SGX</0> and <1>SGXLP</1> to earn rewards.": "<0>SGX</0>と<1>SGXLP</1>をステークして報酬を稼ぐ。",
    "Stake SGX Rewards": "SGX報酬をステークする",
    "Stake Multiplier Points": "マルチプライヤーポイントをステークする",
    "Stake esSGX Rewards": "esSGX報酬をステークする",
    ...
    "The esSGX (IOU) token is transferrable. You can add the token to your wallet and send it to another address to claim if you'd like.":
      "esSGX (IOU)は移転可能です。自分のウォレットに加えてから別のアドレスに移してトークンを請求することもできます。",
    "The esSGX tokens can be staked or vested at any time.":
      '"esSGXはいつでもステークしたりべスティングしたりすることができます。',
    ...
    "This will transfer all your SGX, esSGX, SGXLP and Multiplier Points to your new account.":
      "これにより、あなたのすべてのSGX、esSGX、SGXLP、マルチプライヤーポイントは新たなアカウントに移転されます。",
    ...
    "To purchase SGX on <0>Arbitrum</0>, please change your network.":
      "<0>Arbitrum</0>でSGXを購入するにはネットワークを切り替えてください。",
    "To purchase SGX on <0>Avalanche</0>, please change your network.":
      "<0>Avalanche</0>でSGXを購入するにはネットワークを切り替えてください。",
    ...
    "Total Users": "ユーザー総数",
    "Total Volume": "総取引量",
    "Total value of tokens in SGXLP pool ({chainName})": ["SGXLPプール (", ["chainName"], ")のトークンの総額"],
    Trade: "トレード",
    ...
    "Transfers are only supported if the receiving account has not staked SGX or SGXLP tokens before.":
      "移転は、移転先のアカウントがこれまでにSGXやSGXLPトークンをステークしたことがない場合に限り可能です。",
    ...
    "Vest with SGXLP on Arbitrum": "ArbitrumでSGXLPを使ってべスティングする",
    "Vest with SGXLP on Avalanche": "AvalancheでSGXLPを使ってべスティングする",
    "Vest with SGX on Arbitrum": "ArbitrumでSGXを使ってべスティングする",
    "Vest with SGX on Avalanche": "AvalancheでSGXを使ってべスティングする",
    "Vested SGXLP not withdrawn": "べスティングされたSGXLPで引き出されていないもの",
    "Vested SGX not withdrawn": "べスティングされたSGXで引き出されていないもの",
    ...
    "Withdraw from SGXLP Vault": "SGXLPボールトから出金",
    "Withdraw from SGX Vault": "SGXボールトから出金",
    ...
    "You have {0} esSGX (IOU) tokens.": ["あなたは", ["0"], " esSGX (IOU)トークンを保有しています。"],
    ...
    "Your esSGX (IOU) balance will decrease by your claim amount after claiming, this is expected behaviour.":
      "あなたのesSGX (IOU)残高は請求後に請求額の分だけ減少しますが、これは想定された挙動です。",
    "Your transfer has been completed.": "移転は完了しました。",
    "Your transfer has been initiated.": "移転が開始されました。",
    lolipopi: "lolipopi",
    order: "注文",
    orders: "注文",
    "to start using SGX": "SGXを始めるには",
    "{0}": [["0"]],
    "{0} SGXLP (${1})": [["0"], " SGXLP ($", ["1"], ")"],
    "{0} SGXLP bought with {1} {2}!": [["1"], " ", ["2"], "で", ["0"], " SGXLPを購入しました!"],
    "{0} SGXLP have been reserved for vesting.": [["0"], " SGXLPがべスティングのためにリザーブされました。"],
    "{0} SGXLP sold for {1} {2}!": [["0"], " SGXLPを売却し、", ["1"], " ", ["2"], "を得ました!"],
    ...
    "{text}": [["text"]],
    "さらに、トリガー注文は成り行き注文であり、トリガー価格にての決済が保証されているわけではありません。":
      "さらに、トリガー注文は成り行き注文であり、トリガー価格にての決済が保証されているわけではありません。",
  },
};
