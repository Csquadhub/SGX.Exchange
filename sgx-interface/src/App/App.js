...
import BuySgxLp from "../pages/BuySgxLp/BuySgxLp";
import BuySGX from "../pages/BuySgx/BuySgx";
import Buy from "../pages/Buy/Buy";
import NftWallet from "../pages/NftWallet/NftWallet";
import ClaimEsSGX from "../pages/ClaimEsSgx/ClaimEsSgx";
    ...
    if (!hasMetaMaskWalletExtension()) {
      helperToast.error(
        <div>
          ...
          {userOnMobileDevice ? (
            <Trans>, and use SGX with its built-in browser</Trans>
          ) : (
            <Trans> to start using SGX</Trans>
          )}
          .
        </div>
      );
        ...
        <div className="App-content">
          ...
          {!isHome && (
            <Switch>
              ...
              <Route exact path="/claim_es_SGX">
                <ClaimEsSGX setPendingTxns={setPendingTxns} />
              </Route>
