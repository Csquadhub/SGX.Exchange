...
const tokens = [
  {
    ...
    iouToken: getContract(CHAIN_ID, "GMT_SGX_IOU"),
    cap: MaxUint256,
    bonus: 0,
  },
  {
    ...
    iouToken: getContract(CHAIN_ID, "XGMT_SGX_IOU"),
    cap: MaxUint256,
    bonus: 0,
  },
  {
    ...
    iouToken: getContract(CHAIN_ID, "GMT_USDG_SGX_IOU"),
  ...
  },
  {
    ...
    iouToken: getContract(CHAIN_ID, "XGMT_USDG_SGX_IOU"),
        ...
        <div className="MigrationModal-info-box">
          <div className="App-info-row">
            ...
            <div className="align-right">
              {baseAmount &&
                `${formatAmount(baseAmount, 18, 4, true)} SGX ($${formatAmount(
                  baseAmountUsd,
                  18 + decimals,
                  2,
                  true
          ...
          {token.bonus > 0 && (
            <div className="App-info-row">
              ...
              <div className="align-right">
                {bonusAmount &&
                  `${formatAmount(bonusAmount, 18, 4, true)} SGX ($${formatAmount(
                    bonusAmountUsd,
                    18 + decimals,
                    2,
                    true
          ...
          {token.bonus > 0 && (
            <div className="App-info-row">
              ...
              <div className="align-right">
                {totalAmount &&
                  `${formatAmount(totalAmount, 18, 4, true)} SGX ($${formatAmount(
                    totalAmountUsd,
                    18 + decimals,
                    2,
                    true
...
export default function Migration() {
  ...
  return (
    <div className="Migration Page">
      ...
      <div className="Migration-note">Your wallet: {formatAmount(gmxBalance, 18, 4, true)} SGX</div>
